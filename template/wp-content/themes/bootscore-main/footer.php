...
<footer class="bootscore-footer"style="margint-top:-10%;">
 ...
 <div class="<?= apply_filters('bootscore/class/footer/info', 'bg-body-tertiary text-body-secondary border-top py-2 text-center'); ?> bootscore-footer-info">
    <div class="<?= apply_filters('bootscore/class/container', 'container', 'footer-info'); ?>">
      ...
      <?php endif; ?>
        ...
        <div class="small bootscore-copyright d-flex justify-content-between align-items-center">
  <span class="cr-symbol">&copy; <?= date('Y'); ?></span>
  <strong>Autor: Abraão Polcaro</strong>
</div>
    </div>
  </div>
</footer>
